...
Original release: December 2023. Updated: February 2026.

Archival Nodes of the First Experiment Machine is a workbench. A layout of on-chain proposals, details culled from the chain and presented en masse, tattered but hopeful, for all to see.

*Tokens recapitulate a history. Ideas encoded in proposals and actualized by collective assent.*

Original renderer can be [seen here](../assets/archives.png?raw=True). This renderer used a deterministic but simpler SVG display to showcase the proposals from the DAO. Collectors uncovered this as they explored the rendering and the chain, some notes on their discoveries below.

In early 2024 collectors and artist simulated the first experiment machine, proposing updates to a project, holding a vote. This is saved here for posterity:
...
[Collection ~ expression](https://twitter.com/takenstheorem/status/1746264989432705200).

The newest version of this renderer is [here](../renderer.sol). It uses [Art Blocks](https://docs.artblocks.io/) on-chain p5.js asset to create an interactive visual experience. A workstation. Crumpled ideas, assembled in one place. Interact here on [OnChainChecker.xyz](https://onchainchecker.xyz/fullscreen/ethereum/0xbbcfcc50a2885495ab789e06bab7d8f85d2f73ce/1/animation).

![archive #1](../assets/archive_new.png?raw=True)
